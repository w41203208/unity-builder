...
%UNITY_PATH% -quit -batchmode -nographics -logFile %6\build-log-0.log -projectPath %PROJECT_PATH% -executeMethod BuildTool.Build -buildTarget %BUILD_TARGET% -destinationPath %DESTINATION_PATH%
